...
function changePage(id) {
    ...
    if (code == "Ard") {
        ...
        document
            .getElementById(`${code}${lastVisitPageArd}`)
    ...
    if (code == "Basic") {
        ...
        document
            .getElementById(`${code}${lastVisitPageBasic}`)
            .classList.remove("active");
        document.getElementById(`${code}${pageNo}`).classList.add("active");
    ...
    if (code == "Iot") {
        ...
        document
            .getElementById(`${code}${lastVisitPageIot}`)
            .classList.remove("active");
        document.getElementById(`${code}${pageNo}`).classList.add("active");
    ...
    if (code == "Other") {
        ...
        document
            .getElementById(`${code}${lastVisitPageOther}`)
            .classList.remove("active");
        document.getElementById(`${code}${pageNo}`).classList.add("active");
        lastVisitPageOther = parseInt(pageNo);
    }
    ...
    fetch(url, params).then((response) => {
        ...
        response.json().then((data) => {
            ...
            id1.href = `/Read_more_${code}/` + data["id"][1];
            id2.href = `/Read_more_${code}/` + data["id"][2];
            id3.href = `/Read_more_${code}/` + data["id"][3];
            id4.href = `/Read_more_${code}/` + data["id"][4];
